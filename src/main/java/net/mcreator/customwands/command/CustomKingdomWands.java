...
package net.mcreator.customwands.command;
...
public class CustomKingdomWands implements CommandExecutor {
	@Override
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		if (label.equalsIgnoreCase("ckw")) {
			double x = 0;
			double y = 0;
			double z = 0;
			Entity entity = null;
			...
			});
			{
				...
				CustomKingdomWandsCommandExecutedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
		return false;
